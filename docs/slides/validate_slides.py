...
SKIP_COL_CHECK = {46}        # casehub-devtown User Flow — single col, falsely tagged as grid
SKIP_GAP_CHECK = {30, 53, 54}  # pages philosophy (code block skews gap), Flywheel + Build on Platform (center layout)
SLIDE_H       = 1104
SLIDE_W       = 1960
MID_X         = SLIDE_W // 2
