# Claude Configuration Architecture — CaseHub

> **Source:** https://raw.githubusercontent.com/mdproctor/parent/main/docs/config-architecture.md  
> **Installed to:** `~/.claude/config-architecture.md` — refreshed daily by `update-claude-md`  
> **Generic base:** https://raw.githubusercontent.com/mdproctor/cc-praxis/main/docs/config-architecture.md

This document is the canonical map of the Claude configuration system for the CaseHub platform. Before adding new guidance anywhere, consult this map to find the authoritative location and avoid duplication.
...
### Platform coherence protocol (CaseHub-specific)
...
### Protocols directory (CaseHub-specific)
...
| **Gap**: no single document shows the full chain | Open — tracked in parent#13 |
...
| Skill invocation chain | Scattered, no authoritative source | Open gap (parent#13) |
