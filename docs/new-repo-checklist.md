...
- [ ] **`build/modules-local.csv`** — if the repo also needs to be built locally via
  `build-all.sh` but is NOT a CI module, add it here instead. Same format: `name,dep1,dep2,...`
