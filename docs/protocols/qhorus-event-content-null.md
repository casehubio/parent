---
id: PP-20260508-90428f
title: "Qhorus EVENT message content is always null — never attempt to render it"
type: rule
scope: platform
applies_to: "All projects that read or display Qhorus MessageLedgerEntry records"
severity: important
refs: []
violation_hint: "Content renders as blank with no error; symptom misleads about cause — looks like a UI bug"
created: 2026-05-08
---
