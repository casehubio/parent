---
id: PP-20260508-18ca07
title: "Use absolute paths when running Maven in git worktrees"
type: rule
scope: platform
applies_to: "All modules using git worktrees for parallel development"
severity: important
refs: []
violation_hint: "Relative paths resolve incorrectly after directory context changes, producing misleading build errors"
created: 2026-05-08
---
