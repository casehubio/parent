---
id: PP-20260508-c375b2
title: "@IfBuildProperty/@UnlessBuildProperty are build-time only — QuarkusTestProfile properties have no effect"
type: rule
scope: platform
applies_to: "All modules using conditional bean activation"
severity: critical
refs: []
violation_hint: "Setting the property in QuarkusTestProfile silently has no effect; bean activates based on build-time value only"
created: 2026-05-08
---
