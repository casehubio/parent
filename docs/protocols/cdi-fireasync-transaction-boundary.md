---
id: PP-20260508-c3d5b2
title: "CDI fireAsync() dispatches immediately — observers can run before the triggering transaction commits"
type: rule
scope: platform
applies_to: "All modules using CDI async events"
severity: important
refs: []
violation_hint: "Observer reads entity state before commit; sees stale or absent data with no error"
created: 2026-05-08
---
