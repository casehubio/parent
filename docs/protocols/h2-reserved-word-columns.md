---
id: PP-20260508-29db18
title: "Avoid H2-reserved words as column names in Flyway migrations"
type: rule
scope: platform
applies_to: "All casehub modules with Flyway migrations"
severity: important
refs:
  - docs/protocols/flyway-migration-rules.md
violation_hint: "Column name compiles and runs on PostgreSQL but silently fails on H2 in tests"
created: 2026-05-08
---
