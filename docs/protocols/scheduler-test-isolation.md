---
id: PP-20260508-7e206e
title: "Disable or stub the scheduler in tests that interact with database state"
type: rule
scope: platform
applies_to: "All modules with @Scheduled beans that interact with database state"
severity: important
refs: []
violation_hint: "Scheduler fires against committed test data and corrupts subsequent test assertions"
created: 2026-05-08
---
