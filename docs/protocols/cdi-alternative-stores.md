---
id: PP-20260508-b2e4a1
title: "CDI @Alternative stores in tests must avoid Panache static methods"
type: rule
scope: platform
applies_to: "All modules using @Alternative @Priority(1) in-memory store implementations for testing"
severity: important
refs: []
violation_hint: "Panache statics silently bypass alternatives, returning empty results with no error"
created: 2026-05-08
---
