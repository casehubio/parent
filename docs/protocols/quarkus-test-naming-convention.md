---
id: PP-20260508-4bfd3b
title: "@QuarkusTest classes must be named *Test.java, never *IT.java"
type: rule
scope: platform
applies_to: "All modules with @QuarkusTest classes"
severity: critical
refs: []
violation_hint: "*IT.java is picked up by maven-failsafe-plugin and produces 'Tests run: 0' with no failure signal"
created: 2026-05-08
---
