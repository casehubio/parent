---
id: PP-20260508-e5f7d4
title: "@ConfigMapping interfaces require Javadoc on every method"
type: rule
scope: platform
applies_to: "All Quarkus extensions with @ConfigMapping interfaces"
severity: critical
refs: []
violation_hint: "Missing Javadoc causes a compile error, not a runtime warning — build fails with no obvious indication of cause"
created: 2026-05-08
---
